...
<!-- Mirrored from www.profit-axis.ltd/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 10:09:05 GMT -->
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">

<title>Miners funds: {{$title}}</title>
  ...
  <div class="headerTopContainer">
    <div class="headerTopInner zoomIn wow">
      <div class="hdTop-row1">
        ...
        <p><img src="styles/images/hd-top3.png">E-mail: <span>{{$compd->companyEmail?$compd->companyEmail:""}}</span></p>
      </div>
  ...
  <div class="footerContainer">
    <div class="footerInner">
      <div class="ft-ctn-left">
        <p>Copyright &copy; 2020-2025. <a href="{{route('index')}}">profit-axis.ltd</a> <br>
      ...
      <div class="ft-ctn-mid">
        ...
        <div class="ft-md-part2">
          ...
          <p>E-mail: <a href="mail:{{$compd->companyEmail?$compd->companyEmail:""}}">{{$compd->companyEmail?$compd->companyEmail:""}}</a></p>
        </div>
      </div>
