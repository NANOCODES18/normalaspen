...
<head>
    ...
    <link href="{{asset('imported-css.css')}}" rel="stylesheet" />
    <link href="{{asset('css2/plugins.css')}}" rel="stylesheet">
                ...
                <div class="container hhwwjwjku72jk">
                    <nav>
                        <ul>
                            ...
                            <li><a href="{{route('index')}}#contactform">CONTACT US</a></li>
        ...
        <section class="theme-bg" style="padding-top:40px; padding-bottom: 20px;">
            <div class="container">
                ...
                <div class="heading-text heading-line text-center">
                    <p data-animate="zoomIn" style="color: #fff !important;">Exquisite Option</p>
                </div>
                <div class="row">
                    <div class="col-lg-12" data-animate="bounceInDown" style="max-width: 970px;margin: auto;">
                        <h2 style="font-size: 23px; margin-bottom: 0; color: #fff !important;" class="tup text-center">
                            WHY CHOOSE Exquisite Option?</h2>
                        <p class="text-center" style="color: #fff !important;">
                            Our platform helps you expand your inhvesting horizons and strategies. A coordinated team combining our distinct market insights with rigorous fundamental analysis.
                        </p>
                        <p class="text-center" style="color: #fff !important;">
                            Our main goal in exquisite option is to produce the preservation and increase of own capital and capital of our investors by wise mercantilism within the quality market with risk hedging. Small finance is a chance for many normal investors to save lots of and greatly multiply their capital and to produce himself and his family a good, snug future and appearance into it not with concern, however with anticipation of abundance.
                            We tend to give everybody the chance to become an associate capitalist and make your own extremely profitable quality. Be our customer and enjoy one of the best investment opportunities, Join us today!
                        </p>
                        <div class="row">
                    ...
                    <div class="col-lg-6 p-l-40 p-r-40" data-animate="fadeInRight">
                        <div class="m-b-40 f15">
                            ...
                            <p style="color: #fff !important"> We’re proud to be an asset management company whose
                                ...
                                and a long-term vision. At Exquisite OptionGroup Investments, our vision, mission and
            ...
            <div class="container container-fullscreen">
                <div class="text-middle text-center text-light">
                    <h1 class="text-uppercase text-lg headng_stef d-font-exempt"
                        style=" font-size: 26px !important; margin-bottom: 0; color: #fff !important">Exquisite Option</h1>
                    <p class="lead">
                        ...
                        <div class="carousel arrows-visibile testimonial testimonial-single testimonial-left"
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>I've had incredible customer service since i started investing here, I'm a repeat
                                    investor. I've been investng with Exquisite Option for nearly 3
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>Transparent, profitable, and reliable bitcoin investment company that will make you
                                    real money. Thanks to all of you at Exquisite Option Group for the excellent
                                    service. </p>
                            ...
                            <div class="testimonial-item">
                                ...
                                <p>I have always been searching for an opportunity to earn on bitcoin and finally I
                                    found Exquisite Option Group and they have proven to be very reliable since i've
                    ...
                    <div class="uk-width-1-1@m">
                        <div class="uk-grid uk-grid-small" data-uk-grid="">
                            ...
                            <div class="uk-width-expand">
                                <h3 class="tup" style="color: #fff !important">Why Exquisite Option?</h3>
                                <p style="color: #fff !important">Stake with confidence and benefit from the
                ...
                <div class="row yu8i9kl-uuh">
                    <div style="" class="col-lg-4">
                        ...
                        <span>Empowering investors by providing them an avenue for controlling their financial future by
                            ...
                            traditional assets.
                            Exquisite OptionGroup is dedicated to helping investors around the world reach
                        ...
                        <div class="uk-card uk-card-primary uk-border-rounded uk-background-cover"
                            ...
                            <div class="uk-card-body">
                                ...
                                <p class="uk-margin-small-top c-w" style="max-width: 700px">Our platform is designed for
                                    ...
                                    live chat.</p>
                                <a class="uk-button uk-button-primary uk-border-rounded c-w" href="{{route('register')}}">Open an
                                    Account Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-12" data-animate="fadeIn"> We’re proud to be an asset management company
                                whose culture is driven by strong values and a long-term vision. At Exquisite Option Capital
                                ...
                                Exquisite OptionGroup was founded on a simple but revolutionary idea that an
                                investment company
                                should be run for the sole benefit of its investors. And so Exquisite OptionGroup was
                                designed to be
                                different, removing outside owners and outside interests from the equation. Because of
                                our investor-owned structure, Exquisite Option Group's success can only be measured by
                                your success.
                            </div>
                            <div class="col-lg-12" data-animate="fadeIn"> Low costs, a long-term orientation, and focus
                                on your goals are at the core of
                                Exquisite Option Group's investing philosophy, and not just because they sound good.
                                They're essential
                                ...
                                Exquisite Option Group's mission is to help investors reach their goals, and that
                                means access to
                                ...
                                Strategy matters. Exquisite Option Group's approach to managing investments on behalf
                                of our clients is
        ...
        <section style="padding: 30px">
            <div class="container">
                <div class="tradingview-widget-container" style="width: 100%; height: 450px;">
                    <iframe allowtransparency="true" frameborder="0" src="https://www.tradingview-widget.com/embed-widget/crypto-mkt-screener/?locale=en#%7B%22width%22%3A%22100%25%22%2C%22height%22%3A%22450%22%2C%22defaultColumn%22%3A%22overview%22%2C%22screener_type%22%3A%22crypto_mkt%22%2C%22displayCurrency%22%3A%22GBP%22%2C%22colorTheme%22%3A%22light%22%2C%22market%22%3A%22crypto%22%2C%22enableScrolling%22%3Atrue%2C%22utm_source%22%3A%22Exquisite Optioncapital.com%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22cryptomktscreener%22%7D" style="box-sizing: border-box; height: 450px; width: 100%;"></iframe>
