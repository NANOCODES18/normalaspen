    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-4">
        <div class="box box-default pull-up">
            <img class="card-img-top img-responsive" src="dashb/images/plans/plan{{$loop->index + 1}}.png" alt="Card image cap">
                ...
                <div class="box box-body bg-hexagons-white pull-up">
                  <div class="media align-items-center p-0">
                    <div class="text-center">
                      ...
                      <div>
                      <a href="{{route('plan_specific',$category)}}"><h3 class="no-margin text-bold">{{$category}} Plan</h3></a>
