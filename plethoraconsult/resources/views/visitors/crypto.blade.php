    ...
    <div class="row justify-content-between align-items-center gutter-vr-30px">
        ...
        <div class="col-lg-8">
            <div class="text-block">
                <h5 class="heading-xs dash">Plethora Consult </h5>
                <h2>Cryptocurrencies</h2>
                <p class="lead">
                                        Plethora Consult  now offers all traders the opportunity to trade a wide range of the top ranked digital
    ...
    <div class="row justify-content-center gutter-vr-30px">
        <div class="col-12">
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">Why trade Cryptocurrencies with Plethora Consult ?</h4>
                                        <p>
                                           Cryptocurrencies could potentially be the currency of the future with more people gaining interest and price
                        value going up. Plethora Consult  offers competitive spreads, with no commissions charged on transactions making it
                        more profitable. When trading with Plethora Consult  you are trading on the price changes of the digital coin, and not
                        physically purchasing it.
                        Trading with Plethora Consult  ensures that you will trade with a 100% reputable broker.
