    ...
    <div class="section section-x bg-primary tc-grey" style="padding-bottom: 0px;">
        <div class="container">
            ...
            <div class="row gutter-vr-30px">
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>How long does my deposit take before it can reflect on my Plethora Consult  Investments account
                            dashboard?</h4>
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        ...
                        <p>Yes we are officially and properly registered with the United States, our company
                            registration number is 602425294 and registered with the name Plethora Consult LLC</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="faq-item bg-light">
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>Is Plethora Consult LLC and Plethora Consult  the same?</h4>
                        <p>Plethora Consult LLC is group of companies which Plethora Consult  is under and most of the executives and
                            team of Plethora Consult LLC works for Plethora Consult . Plethora Consult LLC serves as a Parent Company
                            and Affiliate.</p>
                    </div>
                </div>
                <div class="col-12">
