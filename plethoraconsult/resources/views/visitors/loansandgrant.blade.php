        ...
        <div class="col-lg-8">
            <div class="text-block">
                ...
                <p class="lead">
                       ...
                       process! At Plethora Consult , we understand! Our investors want simple facts, honest answers
                       and competitive products.

DGS automatically offers loan services to investors with over $50,000 investment either in our normal Plethora Consult  financial
...
identity of the investor are duly confirmed by Plethora Consult  loan board.
...
GREAT INVESTING WITH Plethora Consult  FAMILY
                                        </p>
            </div>
        </div><!-- .col -->
    </div><!-- .row -->
