...
class Userdashcontroller extends Controller
{
    ...
    public function userdashb_withdrawal_post (Request $req){
        ...
        if ($user_fund->balance < $amount) {
            ...
            return redirect()->route('userdashb_withdrawal')->with('warning', 'Withdrawal failed: reason - Insufficient Funds');
        } else {
            # code...
        ...
        if (Hash::check($password, auth()->user()->password)){
            ...
            if ($newpassword == $cnewpassword) {
                ...
                auth()->user()->password = Hash::make($request->newpassword);
                  ...
                  if ($au) {
                      # code...
                      return redirect()->route('userdashb_profile')->with('success', 'password changed succesfuly');
                  } else {
                      # code...
                      return redirect()->route('userdashb_profile')->with('error', 'password not changed succesfuly');
                  }
