    ...
    <div class="col-md-4">
      <div class="card card-profile text-center">
        <div class="card-header card-avatar">
          <a href="#">
            <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px;" src="assets/images/hiew.JPEG">
          </a>
        </div>
        <div class="card-body">
    ...
    <!--first-->
     ...
     <div class="col-md-4">
      <div class="card card-profile text-center">
        <div class="card-header card-avatar">
          <a href="#">
            <img class="img" style="border: 2px solid white; border-radius: 50%;width:55%;" src="assets/images/one.jpg">
          </a>
        </div>
        <div class="card-body ">
...
<div class="col-md-4">
  <div class="card card-profile text-center">
    ...
    <a href="#">
        <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px;  " src="assets/images/shi.JPEG">
    </a>
    </div>
    <div class="card-body">
...
<div class="row">
    ...
    <div class="col-md-4">
      <div class="card card-profile text-center">
        <div class="card-header card-avatar">
          <a href="#">
            <img class="img" style="border: 2px solid white; border-radius: 50%;width:53%;" src="assets/images/dave.JPEG">
          </a>
        </div>
        <div class="card-body ">
                ...
                <div class="col-md-4">
                  <div class="card card-profile text-center">
                    <div class="card-header card-avatar">
                      <a href="#">
                        <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/mark1.jpg">
                      </a>
                    </div>
                    <div class="card-body">
            ...
            Emily joined {{$compd? $compd->companyname :"company name"}} in 2005 and has served on the firm's five-member IPC since 2011. Prior to her current responsibilities, She held several different positions at the firm, including Capital Markets Research Team Leader, Securities Research Team Leader and Securities Research Analyst. She has a degree in Finance from the University of Arizona. She lives in the San Francisco Bay Area with her husband and two children.
                            ...
                            <div class="col-md-4">
                              <div class="card card-profile text-center">
                                ...
                                <a href="#">
                                    <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/stella.jpg">
                                </a>
                                </div>
                                <div class="card-body">
  ...
  <div class="col-md-4">
    ...
    <div class="card card-profile text-center">
      <div class="card-header card-avatar">
        <a href="#">
          <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/hen.JPEG">
        </a>
      </div>
      <div class="card-body">
              ...
              <div class="col-md-4">
                <div class="card card-profile text-center">
                  <div class="card-header card-avatar">
                      <a href="#">
                      <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px;" src="assets/images/four.jpg">
                      </a>
                  </div>
                  <div class="card-body ">
                          ...
                          <div class="col-md-4">
                            <div class="card card-profile text-center">
                              <div class="card-header card-avatar">
                                <a href="#">
                                  <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px;" src="assets/images/ren.JPEG">
                                </a>
                              </div>
                              <div class="card-body ">
  ...
  <div class="col-md-4">
    <div class="card card-profile text-center">
      <div class="card-header card-avatar">
        <a href="#">
          <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/three.jpg">
        </a>
      </div>
      <div class="card-body">
...
<!--third-->
              ...
              <div class="col-md-4">
                <div class="card card-profile text-center">
                  ...
                  <a href="#">
                      <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/MarkGeller.jpg">
                  </a>
                  </div>
                  <div class="card-body">
                          ...
                          <div class="col-md-4">
                            <div class="card card-profile text-center">
                              <div class="card-header card-avatar">
                                <a href="#">
                                  <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/kim.JPEG">
                                </a>
                              </div>
                              <div class="card-body">
  ...
  <div class="col-md-4">
    ...
    <div class="card card-profile text-center">
      <div class="card-header card-avatar">
        <a href="#">
          <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/fivenew.jpg">
        </a>
      </div>
      <div class="card-body">
...
<!--third-->
              ...
              <div class="col-md-4">
                ...
                <div class="card card-profile text-center">
                  ...
                  <a href="#">
                      <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px; " src="assets/images/guy.JPEG">
                  </a>
                  </div>
                  <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card card-profile text-center">
              <div class="card-header card-avatar">
                  <a href="#">
                  <img class="img" style="border: 2px solid white; border-radius: 50%;width:50%; height:180px;
height:180px;" src="assets/images/mat.JPEG">
                  </a>
              </div>
              <div class="card-body ">
