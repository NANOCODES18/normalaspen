            ...
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">HOW TO INVEST</h4>
                                        <ul>
                                            ...
                                            <li><p><i class="fa fa-check-square"></i> -Send the duly completed form and evidence of payment to support@REEF RESOURCES Financial Managementcapital.com</p></li><br>
