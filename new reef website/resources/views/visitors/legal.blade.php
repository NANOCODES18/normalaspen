    ...
    <div class="row justify-content-between align-items-center gutter-vr-30px">
        ...
        <div class="col-lg-8">
            <div class="text-block">
                ...
                <p class="lead">
                                        REEF RESOURCES Financial Management is one of the most reliable diversified financial investment service
                        ...
                        headquartered in United States, REEF RESOURCES Financial Management have staffs with over 30 years’ experience in
...
profit daily. As a leading global market maker, REEF RESOURCES Financial Management has one of the World’s Largest Independent
