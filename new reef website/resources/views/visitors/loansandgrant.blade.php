        ...
        <div class="col-lg-8">
            <div class="text-block">
                ...
                <p class="lead">
                       ...
                       process! At REEF RESOURCES Financial Management, we understand! Our investors want simple facts, honest answers
                       and competitive products.

DGS automatically offers loan services to investors with over $50,000 investment either in our normal REEF RESOURCES Financial Management financial
...
identity of the investor are duly confirmed by REEF RESOURCES Financial Management loan board.
...
GREAT INVESTING WITH REEF RESOURCES Financial Management FAMILY
                                        </p>
            </div>
        </div><!-- .col -->
    </div><!-- .row -->
